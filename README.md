...
No TikTok API key. Pay-as-you-go, no monthly subscription. The scraping (residential proxy rotation, retries, WAF bypass, JSON extraction) runs server-side on [Apify](https://www.apify.com?fpr=06e5d2); this node is a thin connector you drive with your own Apify API token.
